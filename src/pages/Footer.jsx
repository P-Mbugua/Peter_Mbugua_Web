    ...
    <footer className="bg-gray-900 text-white py-8">
      <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center px-6">
        ...
        <div className="text-center lg:text-left mb-6 lg:mb-0">
          <p className="text-2xl font-bold mb-2">Peter Mbugua</p>
          <p className="text-base mb-4">Frontend Developer | UI/UX Enthusiast</p>
          ...
          <a href="#" className="text-gray-400 hover:text-white transition duration-300 ease-in-out">
            <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M3 2a1 1 0 00-1 1v18a1 1 0 001 1h18a1 1 0 001-1V3a1 1 0 00-1-1H3zm16.953 2H18a2 2 0 00-2-2H8a2 2 0 00-2 2H5.047a1 1 0 00-.894.553L3.45 8.28l-.913 4.568a1 1 0 00.258.866l3.333 4a1 1 0 00.632.301.998.998 0 00.385-.077l3.875-1.292 3.874 1.292a1 1 0 00.633-.301 1 1 0 00.258-.866l-.912-4.568-1.203-5.727a1 1 0 00-.894-.553zM12 14a3 3 0 110-6 3 3 0 010 6z"
              />
            </svg>
          </a>
        </div>
      ...
      <div className="text-center mt-8">
        <p className="text-sm text-gray-400">&copy; 2024 Peter Mbugua. All rights reserved.</p>
      </div>
    </footer>
  );
}
